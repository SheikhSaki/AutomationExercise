...
public class Checkout_Page extends BaseClass{
	...
	public void addressDetails()
	{
		...
		expectedResult.add("Mrs. Leena Nair");
		expectedResult.add("asdef");
		expectedResult.add("Lohegoan, Pune,Maharashtra");
		expectedResult.add("Skyline Appart,Lohegoan, Pune,Maharashtra");
		expectedResult.add("Pune Maharashtra 42434");
		expectedResult.add("India"); 
		expectedResult.add("9898986534"); 
	...
	public String successMessage() throws InterruptedException
	{
		...
		driver.findElement(nameoncard).sendKeys("Ami");
		driver.findElement(cardno).sendKeys("1234");
		driver.findElement(cvc).sendKeys("asdf");
		driver.findElement(expiration).sendKeys("03/2028");
