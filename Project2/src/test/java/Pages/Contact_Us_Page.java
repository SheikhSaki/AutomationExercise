...
public void enterInfo()
	...
	{
		driver.findElement(namefield).sendKeys("Paru");
		...
		driver.findElement(choosefile).sendKeys("E:\\Eclipse New Codes\\my workspace\\automationexercise_Project2\\src\\test\\resources\\testdata\\sample.txt");
