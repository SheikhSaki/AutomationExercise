...
public class Enter_Accounts_Info_Page extends BaseClass {
	...
	public String AccountCreated() throws InterruptedException, IOException
	{
		...
		File f = new File(System.getProperty("user.dir") + "\\src\\test\\resources\\testdata\\SigninDetails.xlsx");
		...
		fis.close();
//		driver.findElement(firstname).sendKeys("Leena");
//		driver.findElement(Lastname).sendKeys("Nair");
//		driver.findElement(company).sendKeys("asdef");
//		driver.findElement(address).sendKeys("Lohegoan, Pune,Maharashtra");
//		driver.findElement(address2).sendKeys("Skyline Appart,Lohegoan, Pune,Maharashtra");
...
//		driver.findElement(Zipcode).sendKeys("42434");
//		driver.findElement(mobnumber).sendKeys("9898986534");
		return null;
