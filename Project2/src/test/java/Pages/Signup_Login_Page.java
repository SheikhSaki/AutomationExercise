...
public String enterAccountInfo() {
		...
		driver.findElement(name).sendKeys("ami");
		driver.findElement(emailfield).sendKeys("ami1234@gmail.com");
...
{
	driver.findElement(email).sendKeys("akku@gmail.com");
...
{
	driver.findElement(email).sendKeys("asdfg@gmail.com");
...
{
	driver.findElement(email).sendKeys("paru@gmail.com");
	driver.findElement(password).sendKeys("12345");
	driver.findElement(login).click();
...
public String enterExistingAccountInfo() {
	...
	driver.findElement(name).sendKeys("paru");
	driver.findElement(emailfield).sendKeys("paru@gmail.com");
	driver.findElement(signup).click();
...
{
	driver.findElement(email).sendKeys("ammu@gmail.com");
	driver.findElement(password).sendKeys("12345");
	driver.findElement(login).click();
}
